...
<div class="content-wrapper">
    <div class="content-padding">
        <section class="content-header">
            ...
            <a href="/admin/inventory/categories/{{$id}}/edit" class="btn bg-purple">Edit</a>
            ...
            <form action="{{ action('Admin\Inventory\CategoryController@destroy', $id) }}" method="post" id="delete">
                {!! method_field('delete') !!}
                @csrf
            </form>
        </section>
